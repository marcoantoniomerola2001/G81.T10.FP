...
from secure_all import AccessManager, AccessManagementException, \
    AccessKey, JSON_FILES_PATH, KeysJsonStore, RequestJsonStore, OpenDoorJsonStore
...
class TestAccessManager(unittest.TestCase):
    ...
    def test_open_door_bad_key_regex(self):
        ...
        with self.assertRaises(AccessManagementException) as c_m:
            my_key.open_door("cc161c01a4bcca82e841b3446e2a3edb3539d72a3a7ec40a07d236998482906")
    ...
    def test_open_door_bad_key_is_not_found(self):
        ...
        my_key = AccessManager()
        with self.assertRaises(AccessManagementException) as c_m:
            my_key.open_door("fff00d78646ed41a91d60ec2fc1ed326238e510134ca52e5d9b1de5cbdf2b8ab")
